...
#define F1_GPIO_PIN    GPIO_Pin_15
#define F2_GPIO_PIN    GPIO_Pin_14
#define F3_GPIO_PIN    GPIO_Pin_13
#define F4_GPIO_PIN    GPIO_Pin_10
#define F5_GPIO_PIN    GPIO_Pin_11
#define F6_GPIO_PIN    GPIO_Pin_12
...
#define F1_RCC    RCC_APB2Periph_GPIOE
#define F2_RCC    RCC_APB2Periph_GPIOE
#define F3_RCC    RCC_APB2Periph_GPIOE
#define F4_RCC    RCC_APB2Periph_GPIOB
#define F5_RCC    RCC_APB2Periph_GPIOB
#define F6_RCC    RCC_APB2Periph_GPIOB
...
#define FootValue	(GPIO_ReadInputDataBit(F1_GPIO_PORT,F1_GPIO_PIN) | \
					(GPIO_ReadInputDataBit(F2_GPIO_PORT,F2_GPIO_PIN) << 1) | \
					(GPIO_ReadInputDataBit(F3_GPIO_PORT,F3_GPIO_PIN) << 2) | \
					(GPIO_ReadInputDataBit(F4_GPIO_PORT,F4_GPIO_PIN) << 3) | \
					(GPIO_ReadInputDataBit(F5_GPIO_PORT,F5_GPIO_PIN) << 4) | \
					(GPIO_ReadInputDataBit(F6_GPIO_PORT,F6_GPIO_PIN) << 5))
