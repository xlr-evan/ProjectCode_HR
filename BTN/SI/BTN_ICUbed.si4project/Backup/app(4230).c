				...
				switch(KEY_Scan(OUT))
				{
					case 0x09:
								...
								if(!bedLock)
								{
									LED9 = 0;
									RS485_RDTX_EN;
									USART2_SendDate("%x",OUTBED_UP_ON);
								}
								while(KEY_Scan(OUT));
								USART2_SendDate("%x",OUTBED_UP_OFF);
								RS485_RDRX_EN;
								LED9 = 1;	
								break;
					case 0x10:
								...
								if(!backLock) 
								{
									LED10 = 0;
									RS485_RDTX_EN;
									USART2_SendDate("%x",OUTBACK_UP_ON);
								}
								while(KEY_Scan(OUT));
								USART2_SendDate("%x",OUTBACK_UP_OFF);
								RS485_RDRX_EN;
								LED10 = 1;	
								break;							
					case 0x11:
								...
								if(!legLock)
								{
									LED11 = 0;
									RS485_RDTX_EN;
									USART2_SendDate("%x",OUTLEG_UP_ON);
								}
								while(KEY_Scan(OUT));
								USART2_SendDate("%x",OUTLEG_UP_OFF);
								RS485_RDRX_EN;
								LED11 = 1;	
								break;
					case 0x12:
								...
								if(!pitchLock)
								{
									LED12 = 0;
									RS485_RDTX_EN;
									USART2_SendDate("%x",OUTPITCH_AFTER_ON);
								}
								while(KEY_Scan(OUT));
								USART2_SendDate("%x",OUTPITCH_AFTER_OFF);
								RS485_RDRX_EN;
								LED12 = 1;	
								break;
					case 0x13:
								...
								if(!rollLock)
								{
									LED13 = 0;
									RS485_RDTX_EN;
									USART2_SendDate("%x",OUTROLL_LEFT_ON);
								}
								while(KEY_Scan(OUT));
								USART2_SendDate("%x",OUTROLL_LEFT_OFF);
								RS485_RDRX_EN;
								LED13 = 1;	
								break;
					case 0x14:
					...
					case 0x19:
								...
								if(!bedLock) 
								{
									LED19 = 0;
									RS485_RDTX_EN;
									USART2_SendDate("%x",OUTBED_DOWN_ON);
								}
								while(KEY_Scan(OUT));
								USART2_SendDate("%x",OUTBED_DOWN_OFF);
								RS485_RDRX_EN;
								LED19 = 1;	
								break;
					case 0x20:
								...
								if(!backLock) 
								{
									LED20 = 0;
									RS485_RDTX_EN;
									USART2_SendDate("%x",OUTBACK_DOWN_ON);
								}
								while(KEY_Scan(OUT));
								USART2_SendDate("%x",OUTBACK_DOWN_OFF);
								RS485_RDRX_EN;
								LED20 = 1;	
								break;		
					case 0x21:
								...
								if(!legLock)
								{
									LED21 = 0;
									RS485_RDTX_EN;
									USART2_SendDate("%x",OUTLEG_DOWN_ON);
								}
								while(KEY_Scan(OUT));
								USART2_SendDate("%x",OUTLEG_DOWN_OFF);
								RS485_RDRX_EN;
								LED21 = 1;	
								break;						
					case 0x22:
								...
								if(!pitchLock) 
								{
									LED22 = 0;
									RS485_RDTX_EN;
									USART2_SendDate("%x",OUTPITCH_FRONT_ON);
								}
								while(KEY_Scan(OUT));
								USART2_SendDate("%x",OUTPITCH_FRONT_OFF);
								RS485_RDRX_EN;
								LED22 = 1;	
								break;
					case 0x23:
								...
								if(!rollLock) 
								{
									LED23 = 0;
									RS485_RDTX_EN;
									USART2_SendDate("%x",OUTROLL_RIGHT_ON);
								}
								while(KEY_Scan(OUT));
								USART2_SendDate("%x",OUTROLL_RIGHT_OFF);
								RS485_RDRX_EN;
								LED23 = 1;	
								break;
					case 0x24:
								...
								LED24 = 0;
								RS485_RDTX_EN;
								USART2_SendDate("%x",OUT_CALL_ON);
								while(KEY_Scan(OUT));
								USART2_SendDate("%x",OUT_CALL_OFF);
								RS485_RDRX_EN;
								LED24 = 1;
								break;								
					case 0x25:	
								...
								LED25 = 0;
								RS485_RDTX_EN;
								USART2_SendDate("%x",OUT_FLOWER_ON);
								while(KEY_Scan(OUT));
								USART2_SendDate("%x",OUT_FLOWER_OFF);
								RS485_RDRX_EN;
								LED25 = 1;
								break;	
					case 0x26:
								...
								LED26 = 0;
								RS485_RDTX_EN;
								USART2_SendDate("%x",OUT_CCP_ON);
								while(KEY_Scan(OUT));
								USART2_SendDate("%x",OUT_CCP_OFF);
								RS485_RDRX_EN;
								LED26 = 1;
								break;	
					case 0x27:
								...
								LED27 = 0;
								RS485_RDTX_EN;
								USART2_SendDate("%x",OUT_CPR_ON);
								while(KEY_Scan(OUT));
								USART2_SendDate("%x",OUT_CPR_OFF);								
								RS485_RDRX_EN;
								LED27 = 1;
								break;	
					case 0x28:
				...
				switch(KEY_Scan(IN))
				{
					case 0x01:
							...
							if(!backLock) 
							{
								LED1 = 0;
								RS485_RDTX_EN;
								USART2_SendDate("%x",INBACK_UP_ON);
								
							}
							while(KEY_Scan(IN));
							USART2_SendDate("%x",INBACK_UP_OFF);
							RS485_RDRX_EN;
							LED1 = 1;
							break;
					case 0x02:
							...
							if(!legLock)
							{
								LED2 = 0;
								RS485_RDTX_EN;
								USART2_SendDate("%x",INLEG_UP_ON);
							}
							while(KEY_Scan(IN));
							USART2_SendDate("%x",INLEG_UP_OFF);
							RS485_RDRX_EN;
							LED2 = 1;
							break;
					case 0x03:
							...
							LED3 = 0;
							RS485_RDTX_EN;
							USART2_SendDate("%x",IN_CALL_ON);
							while(KEY_Scan(IN));
							USART2_SendDate("%x",IN_CALL_OFF);
							RS485_RDRX_EN;
							LED3 = 1;
							break;
					case 0x04:
					...
					case 0x06:
							...
							if(!backLock) 
							{
								LED8  = 0;
								RS485_RDTX_EN;
								USART2_SendDate("%x",INBACK_DOWN_ON);
							}
							while(KEY_Scan(IN));
							USART2_SendDate("%x",INBACK_DOWN_OFF);
							RS485_RDRX_EN;
							LED8 = 1;
							break;
					case 0x07:
							...
							if(!legLock) 
							{
								LED7 = 0;
								RS485_RDTX_EN;
								USART2_SendDate("%x",INLEG_DOWN_ON);
							}
							while(KEY_Scan(IN));
							USART2_SendDate("%x",INLEG_DOWN_OFF);
							RS485_RDRX_EN;
							LED7 = 1;
							break;
					case 0x08:
